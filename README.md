...
- **High-frequency native sword combat:** the entity's delayed melee attack is tuned to a conservative 0.25-second attack duration, approximately 12–14 CPS-equivalent timing. Bedrock script cannot inject literal client clicks.
...
- **BedWars maps and economy:** BedWars offers a party-wide vote over Skyline, Canyon, Ruins, and Factory map templates, generates the winning arena at a fresh coordinate such as `501 50 140` rather than using one fixed lobby, and cleans up its temporary map at the end. Players receive timed iron, gold, diamond, and emerald resources and can open **Shop & Upgrades** to buy wool, stone, end stone, weapons, armor, golden apples, Sharpness, Protection, Haste, and Forge team upgrades.
